#!/usr/bin/env bash
# ==============================================================================
# VertiGIS Studio Web SDK Upstream Synchronization Script
# Synchronizes with the official VertiGIS upstream repository (upstream/master),
# protecting enterprise template overlays and custom scripts from conflicts,
# and pushes updates to GitHub (origin/master).
# ==============================================================================
...
main() {
    echo ""
    echo "========================================================================"
    log_info "Synchronizing 01-Vertigis-Web-SDK with upstream (Branch: ${BRANCH})"
    echo "========================================================================"
    ...
    if ! git remote get-url upstream >/dev/null 2>&1; then
        log_info "Adding upstream remote (https://github.com/vertigis/vertigis-web-sdk.git)..."
        git remote add upstream https://github.com/vertigis/vertigis-web-sdk.git
    fi
    ...
    echo ""
    echo "========================================================================"
    log_success "01-Vertigis-Web-SDK successfully synchronized with upstream!"
    echo "========================================================================"
}
